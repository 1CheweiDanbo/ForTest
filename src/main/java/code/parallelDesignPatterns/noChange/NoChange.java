package code.parallelDesignPatterns.noChange;
/**
...
public final class NoChange { //final确保不会被继承

    private final String a; //private 确保不可被访问，final确保不可被修改
    private final String b;
    private final double c;

    public NoChange(String a, String b, double c) {
